...
| #527 — corpus AIMS/Crewtopia real + auditoria diferencial | **Em andamento** — 16 PDFs reais recebidos; pipeline real (`parsePdfOnServer`) rodado contra 2 revisões, formato Escala falha em ambas (bug real de apresentação, relevante para #510); fixtures permanentes ainda não geradas (ver `CORPUS.md`) | #510, #512, #513, #519, #525, #526, #233 |
