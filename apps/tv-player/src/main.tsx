...
function App() {
  ...
  useEffect(() => {
    ...
    const tick = setInterval(() => {
      ...
      setClock(new Date());
      if (Date.now() - lastInput.current > 120000) { setView('Agora'); setMode('ambient'); }
