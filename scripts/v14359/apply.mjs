...
if (!source.includes(marker)) {
  ...
  replaceRequired(
    ...
    `      title: 'Madrugadas trabalhadas em 168h — revisar janela real',\n      description: 'Até ' + maxNightOpsWindow + ' madrugada(s) efetivamente trabalhada(s) em janela móvel de 168h.',\n      details: 'A janela usa o horário real em que cada atividade toca 00:00–06:00, inclui ocorrências exatamente no limite de 168h conforme o contrato protegido e reinicia após ' + actRules.nightOps.resetAfterFreeHours + 'h livres. HSB sem acionamento é exibido separadamente e não entra nesta soma.',`,
