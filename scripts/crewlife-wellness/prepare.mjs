...
patch('android-wrapper/app/src/main/java/com/crewcheck/app/MainActivity.java', source => {
  ...
  source = replace(source, '        CrewLifeWatchPublisher.retryPendingRevocation(this, this::dispatchCrewCheckWatchSyncResult);', '        CrewLifeWatchPublisher.retryPendingRevocation(this, this::dispatchCrewCheckWatchSyncResult);\n        if (samsungWellnessBridge != null) samsungWellnessBridge.setForeground(true);');
