...
assert(home.includes("const DEFAULT_VERSION = '13.8.8'"), 'Home versionada 13.8.8');
assert(auth.includes('data-version="13.8.8"'), 'cadastro versionado 13.8.8');
...
assert(!/^SMTP_/m.test(envExample), 'template sem SMTP');
