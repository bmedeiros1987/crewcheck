...
assert(home.includes("const DEFAULT_VERSION = '13.9.2'") || home.includes("const DEFAULT_VERSION = '13.9.1'") || home.includes("const DEFAULT_VERSION = '13.9.0'") || home.includes("const DEFAULT_VERSION = '13.8.8'"), 'Home versionada em release auditada');
