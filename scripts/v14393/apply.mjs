...
for (const file of [homeFile, rosterFile, offlineFile]) {
...
console.log(`[v14393] CrewCheck ${VERSION}: fila local sobe antes da verdade ativa da conta; reconexão entre canais e descanso na base permanecem canônicos.`);
