...
assert.ok(server.includes("fallbackFrom: travelMode === 'DRIVE' ? 'TomTom' : undefined"), 'fallback Google deve informar origem sem expor segredo');
...
const googleKeyRead = handler.indexOf('const googleKey = googleRoutesServerKey()');
