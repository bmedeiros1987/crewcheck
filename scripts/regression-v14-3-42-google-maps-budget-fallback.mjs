...
assert.ok(home.includes("const DEFAULT_VERSION = '14.3.48';"), 'a preparação final deve terminar na versão Web/PWA 14.3.48');
assert.ok(home.includes('mapsBudget?: {'), 'cliente deve aceitar o diagnóstico de cota');
assert.ok(release.includes('14.3.48'), 'release final deve anunciar 14.3.48');
