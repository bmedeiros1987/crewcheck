...
if (!database.includes(overlapMarker)) {
  ...
  // v14.3.71 materializes active-roster identity reconciliation before this P0
  // preparation runs, so anchor the one direct remote return rather than the whole
  // pre-v14.3.71 if-block. Requiring exactly one occurrence keeps the patch fail-closed.
