...
expect('canonical release', String(release.version) === VERSION, `esperado ${VERSION}, obtido ${release.version}`);
...
for (const [label, path] of [
  ...
  ['Telegram location module', 'server/v14316/telegramLocation.mjs'],
...
contains('Places distance ranking', 'server/v14316/telegramLocation.mjs', "rankPreference: 'DISTANCE'");
contains('Telegram request location', 'server/v14316/telegramLocation.mjs', 'request_location: true');
