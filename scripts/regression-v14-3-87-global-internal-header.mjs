...
assert.match(css, /@media \(max-width: 720px\)[\s\S]*\.cz-global-header \.cz-brand-lockup \{[\s\S]*min-height: 44px !important/, 'lockup mobile deve neutralizar o mínimo desktop de 72px e caber no espaçador');
