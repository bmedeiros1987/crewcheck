...
// Writers anteriores reconstroem delivery.mjs; por isso reaplicamos aqui
// somente os dois headers seguros necessários para ligar o 202 aos webhooks posteriores.
