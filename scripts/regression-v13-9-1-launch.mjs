...
assert(home.includes("const DEFAULT_VERSION = '13.9.1'") || home.includes("const DEFAULT_VERSION = '13.9.2'"), 'Home versionada na linha 13.9.x');
...
assert(manifest.includes('\"version\": \"13.9.1\"') || manifest.includes('\"version\": \"13.9.2\"'), 'manifest PWA na linha 13.9.x');
assert(manifest.includes('crewcheck-icon-v2.png?v=1391') || manifest.includes('crewcheck-icon-v2.png?v=1392'), 'logo atual no PWA');
assert(androidManifest.includes('@drawable/crewcheck_icon_site'), 'logo atual no launcher Android');
assert(androidGradle.includes("versionName '13.9.1'") || androidGradle.includes("versionName '13.9.2'"), 'Android versionName na linha 13.9.x');
