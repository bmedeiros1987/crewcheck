...
if (!source.includes("from '@/lib/pwaSharedPdfRuntime'")) {
  const importMatch = source.match(/^import ManualRegulationView[^\n]*;$/m);
  if (!importMatch) throw new Error('[p0-shared-pdf:home] import atual de ManualRegulationView não localizado');
