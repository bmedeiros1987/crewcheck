...
# Some Play app states reject edits.validate because the change cannot be submitted
# for review automatically. Commit the internal-test edit explicitly without sending
# it for review; a human can submit review later in Play Console when required.
...
print('[android-play] internal review-safe release policy OK')
