...
assert.match(platform,/SELECT stay_date,hotel_name,airport,presentation_time,lead_minutes,updated_at FROM crewcheck_platform_stays WHERE owner_email=\$1 AND roster_key=\$2/);
