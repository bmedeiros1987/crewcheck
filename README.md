# CrewCheck v11.0.85 — Telegram Concierge com áudio mais natural
...
- Workflow do GitHub publica o AAB, APK e `crewcheck-mapping-v11.0.85.txt` como assets da release.
- Use o `app-release.aab` na Play Console e envie o arquivo `crewcheck-mapping-v11.0.85.txt` como arquivo de desofuscação da mesma versão.
