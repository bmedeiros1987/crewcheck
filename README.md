...
- Tripulação falada com função antes do nome:
  ...
  - `FO` → Copiloto
  - `CMS` → Comissário
- Aeroportos e voos ficam mais naturais no áudio: `BSB` vira Brasília, `GRU` vira Guarulhos, `LA1234` vira voo companhia aérea 1234.
...
- Seleção automática ou manual da função:
  - ACT Aeronautas Comissários 2025/2027.
  - ACT Aeronautas Pilotos 2025/2027.
...
## Revisão de precisão operacional - siglas companhia aérea/Aeronautas
...
- Motor de diárias calibrado com demonstrativos companhia aérea reais.
