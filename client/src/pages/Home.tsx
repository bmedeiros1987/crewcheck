...
Contexto: mensagem enviada pela área de Ajuda do CrewCheck.`,
 ...
 function renderCategoryContent() {
  ...
  if (activeCategory === 'alerts') {
   ...
   const alertItems: Array<[string, string, string]> = [['smartDeparture','Saída Inteligente','hora de sair, margem, modal e rota'], ['gateStatus','Portão e terminal','portão, terminal, embarque e última chamada'], ['traffic','Trânsito e rota','tempo estimado, fonte, atraso e alternativa'], ['radar','Radar de voo','somente mudança útil: status, portão, terminal ou previsão'], ['radarImportantOnly','Radar anti-spam','silencia Programado repetido sem portão/alteração'], ['irregularities','Irregularidades','descanso, jornada e alertas críticos'], ['dailySummary','Resumo diário','programação do dia e pontos de atenção'], ['weeklySummary','Resumo semanal','diárias, salário estimado e pendências'], ['concierge','Concierge por texto','responder perguntas sobre escala, portão, saída, diárias e rotina'], ['roster','Escala','importação, alteração e próximo evento']];
   return (
...
if (activeCategory === 'telegram') {
   ...
   return (
    <div className="space-y-5">
     ...
     <SettingsCategoryCard eyebrow="Telegram Premium" title="Alertas importantes fora do app" description="Canal executivo de alertas e perguntas por texto: escala, portão, Saída Inteligente, radar, diárias, rotina e irregularidades com limites no gratuito e experiência completa no Premium.">
      ...
      <div className="mt-4 grid gap-3 sm:grid-cols-2">
       {[
        ...
        ['concierge', 'Concierge por texto', 'responder perguntas digitadas no Telegram'],
