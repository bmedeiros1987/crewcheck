...
type HomeView = 'home' | 'import' | 'history' | 'calendar' | 'billing' | 'iflight' | 'flightboard' | 'departure' | 'routine' | 'perdiem' | 'salary' | 'currency' | 'parking' | 'regulation' | 'c32f' | 'settings' | 'support' | 'notes' | 'chief' | 'medical' | 'bids' | 'admin' | 'systemstatus' | 'more';
...
function Home() {
 ...
 useEffect(() => {
  try {
   ...
   if (target && ['home','import','history','calendar','billing','iflight','flightboard','departure','routine','perdiem','salary','currency','parking','regulation','c32f','settings','support','notes','chief','medical','bids','admin','systemstatus','more'].includes(target)) {
