...
const DEFAULT_VERSION = '13.3.7';
const CREWCHECK_UI_CORE_NOTE = 'v13.3.7: espaçamento premium no cabeçalho do Roster e títulos compactos de DR/HSB';
