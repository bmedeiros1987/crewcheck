   ...
   {open && (
    <div className="crewcheck-speed-dial-panel mb-3 w-[min(21rem,calc(100vw-2rem))] rounded-[1.55rem] border p-3 shadow-2xl backdrop-blur-2xl">
     <div className="mb-2 flex items-center justify-between px-2">
      ...
      <span className="rounded-full px-2 py-1 text-[9px] font-black uppercase tracking-[0.12em]">v11.0.88</span>
     </div>
   ...
   <div className="mx-auto max-w-5xl">
    ...
    <div className="mt-5 grid gap-3 md:grid-cols-3">
     ...
     <div className="rounded-[1.4rem] border border-emerald-200/15 bg-emerald-300/10 p-4">
      ...
      <p className="mt-1 text-xs font-semibold text-emerald-50/70">{storage?.configured ? 'Banco atual segue como principal; PDF original salvo como backup privado.' : 'Banco atual ativo. Supabase entra apenas como backup/redundância se configurado.'}</p>
     </div>
