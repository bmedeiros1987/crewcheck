...
type ZeroView =
  ...
  | 'radar' | 'weather' | 'perdiem' | 'salary' | 'reports' | 'calendar' | 'exports' | 'routine' | 'database' | 'crew' | 'load' | 'wakeup' | 'hotels' | 'presentation' | 'mycar' | 'iflight';
...
const CREWCHECK_UI_CORE_NOTE = 'v13.4.7: pernoite completo, meteorologia operacional, financeiro e sistemas antigos no layout novo';
...
function normalizeInitialView(value: string | null): ZeroView {
  ...
  if (value === 'mycar' || value === 'meucarro' || value === 'carro') return 'mycar';
