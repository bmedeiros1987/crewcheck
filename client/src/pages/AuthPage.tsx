...
export default function AuthPage() {
  ...
  useEffect(() => { const light = localStorage.getItem('crewcheck_theme_mode') === 'light' || localStorage.getItem('crewcheck_light_premium') === '1'; document.documentElement.dataset.crewTheme = light ? 'light' : 'dark'; document.documentElement.classList.toggle('dark', !light); document.documentElement.style.colorScheme = light ? 'light' : 'dark'; localStorage.setItem('crewcheck_last_loaded_version', '12.5.78'); }, []);
