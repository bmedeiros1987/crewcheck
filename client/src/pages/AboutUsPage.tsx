...
export default function AboutUsPage() {
  return (
    <main className="cc-about" lang="pt-BR">
      ...
      <section className="cc-about-partnership">
        <div className="cc-about-partnership-icon"><HeartHandshake /></div>
        <div>
          <span className="cc-about-eyebrow">PARCERIA · JUNTOS POR QUEM VOA</span>
          <h2>CrewCheck + CrewTopia</h2>
          <p>O CrewCheck agradece especialmente ao <strong>Marlon, da CrewTopia</strong>, pela receptividade, pela troca de experiências e pela contribuição que seu trabalho traz à comunidade de tripulantes. Acreditamos que a tecnologia para a aviação evolui quando existe respeito, colaboração e disposição para compartilhar conhecimento.</p>
          <p className="cc-about-partnership-legal"><strong>Parceria, não fusão.</strong> CrewCheck e CrewTopia permanecem produtos, marcas, equipes e operações independentes. Esta parceria representa colaboração e aproximação entre projetos que compartilham o propósito de tornar a rotina de quem voa melhor; não implica incorporação, aquisição, sociedade, controle comum ou unificação das plataformas.</p>
          <strong className="cc-about-partnership-motto">We Do Care About Us!</strong>
        </div>
      </section>
      ...
      <style>{`
        ...
        .cc-about-partnership{display:grid;grid-template-columns:auto 1fr;gap:20px;align-items:start;margin-top:18px;padding:28px;border:1px solid rgba(249,115,22,.42);border-radius:26px;background:linear-gradient(135deg,rgba(11,28,49,.98),rgba(38,24,23,.96));box-shadow:0 18px 50px rgba(0,0,0,.18)}.cc-about-partnership-icon{display:grid;place-items:center;width:58px;height:58px;border-radius:18px;background:linear-gradient(135deg,#ec4899,#f97316);box-shadow:0 10px 28px rgba(249,115,22,.18)}.cc-about-partnership-icon svg{width:30px;height:30px}.cc-about-partnership p{max-width:900px}.cc-about-partnership p+p{margin-top:14px}.cc-about-partnership-legal{padding:14px 16px;border-radius:15px;border:1px solid rgba(103,232,249,.2);background:rgba(6,16,31,.5);font-size:14px}.cc-about-partnership-motto{display:inline-block;margin-top:16px;color:#f9a8d4;letter-spacing:.08em}
        ...
        @media(max-width:680px){.cc-about-topbar{align-items:flex-start}.cc-about-topbar nav{display:none}.cc-about-hero{padding-top:30px}.cc-about-founder{grid-template-columns:1fr;padding:18px}.cc-about-photo-wrap{max-width:310px;margin:auto}.cc-about-partnership{grid-template-columns:1fr;padding:20px}.cc-about-story-grid,.cc-about-capabilities,.cc-about-principles{grid-template-columns:1fr}.cc-about-actions a{width:100%}.cc-about-maintenance{grid-template-columns:1fr}.cc-about-maintenance>a{grid-column:auto}.cc-about-footer{display:grid;text-align:center;justify-items:center}.cc-about-footer>div{justify-content:center}}
