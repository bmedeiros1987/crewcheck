...
const COMPLIANCE_ENGINE_VERSION = '11.0.94';
...
function getFlightHours(day: RosterDay): number {
  ...
  if (legs.length) {
    ...
    // v11.0.94: o total de flyingHours vindo do PDF convertido pode herdar
...
export function analyzeCompliance(roster: CrewRoster, roleSelection: CrewRoleSelection = 'auto'): ComplianceResult {
  ...
  sortedDays.forEach((day, index) => {
    ...
    // v11.0.94: tempo em solo entre etapas deixou de gerar alerta automático.
    ...
    if (day.type === 'VOO') {
      ...
      // v11.0.94: se o parser precisou estimar porque a janela foi contaminada
  ...
  // v11.0.94: jornada semanal é mantida como métrica interna. Não vira alerta
  ...
  // v11.0.94: limite mensal de jornada/trabalho fica como métrica, não como
