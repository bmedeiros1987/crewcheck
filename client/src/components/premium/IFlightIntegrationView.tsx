...
const IFlightIntegrationView: React.FC<IFlightIntegrationViewProps> = ({ onBack, onSuccess, onFileUpload, onRosterImport }) => {
  ...
  const [message, setMessage] = useState('iFlight AutoPull restrito ao administrador. Usuários finais continuam com importação manual de PDF oficial. Em navegadores comuns, bloqueios de segurança do portal podem impedir a captura automática.');
                ...
                <div className="mt-4 rounded-[1.5rem] border border-cyan-300/20 bg-cyan-300/[0.07] p-4">
                  <div className="flex flex-wrap items-start justify-between gap-3">
                    <div>
                      ...
                      <p className="mt-2 text-xs leading-5 text-slate-300">No navegador comum, pode não ser possível abrir o iFlight internamente se o portal bloquear a sessão. No Android, o AutoPull usa navegador interno e tenta capturar o PDF autorizado; como alternativa administrativa, importe o PDF oficial.</p>
                    </div>
