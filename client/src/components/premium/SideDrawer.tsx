...
const NAV_SECTIONS = [
  ...
  },
  {
    ...
    icon: Sparkles,
    items: [
      { view: 'flightboard', label: 'Radar',            icon: Radar,    home: true },
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '1.25rem 1rem 0.875rem', borderBottom: '1px solid var(--sidebar-border)', paddingTop: 'calc(1.25rem + env(safe-area-inset-top, 0))' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.625rem' }}>
            ...
            <div>
              ...
              <p style={{ fontSize: '0.625rem', fontWeight: 700, letterSpacing: '0.12em', textTransform: 'uppercase', color: 'var(--foreground-subtle)' }}>Premium <span className="cc12558-premium-beta-chip">Beta</span> Roster</p>
            </div>
          </div>
          <button
            onClick={onClose}
