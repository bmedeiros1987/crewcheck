...
function CrewCheckGlobalBottomMenu() {
  ...
  const items = [
    ...
    { id: 'vivo', symbol: '✈', label: 'Extra', full: 'Voo de Extra', action: () => goHomeView('departure', 'vivo'), active: false },
...
export default function App() {
  ...
  useEffect(() => {
    ...
    try {
      window.localStorage.setItem('crewcheck_last_loaded_version', '11.0.21');
